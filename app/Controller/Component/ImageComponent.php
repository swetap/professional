...
class ImageComponent extends Object
{
    ...
    */    
    ...
    function upload_image_and_thumbnail($data, $datakey, $imgscale, $thumbscale, $folderName, $square) {
        ...
        if (strlen($data['Videosetting'][$datakey]['name'])>4){
                    $error = 0;
                    ...
                    $filetype = $this->getFileExtension($data['Videosetting'][$datakey]['name']);
                    ...
                    {
                        // Get the image size
                        $imgsize = GetImageSize($data['Videosetting'][$datakey]['tmp_name']);
                    }
                    ...
                    if (is_uploaded_file($data['Videosetting'][$datakey]['tmp_name']))
                    {
                        // Copy the image into the temporary directory
                        if (!copy($data['Videosetting'][$datakey]['tmp_name'],"$tempfile"))
                        {
	...
	function upload_image_and_thumbnail_model($data, $datakey, $imgscale, $thumbscale, $folderName, $square, $model) {
